...
<?php
    //tổng số dòng
    $queryTSD = "SELECT COUNT(*) AS TSD  FROM loai";
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                        ...
                                        if(($search)){
                                            ...
                                            $query = "SELECT * FROM loai ORDER BY id_loai ASC LIMIT {$offset}, {$row_count}";
                                        }
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="dataTables-example_info" style="margin-top:27px">Trang <?php echo $current_page; ?> của <?php echo $TongSoTrang; ?> trang danh mục</div>
                                </div>
                                <div class="col-sm-6" style="text-align: right;">
