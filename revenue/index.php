                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                                ...
                                <div class="col-sm-12" style="text-align: right;">
                                    <form method="get" action="">
                                        ...
                                        <input type="search" name="search" class="form-control input-sm"
                                               placeholder="Nhập tên hoặc danh mục của sản phẩm"
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                while ($arItem = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td style="text-align: center;"><?php echo number_format($gia_tong);
                                            echo "đ"; ?></td>
                                        <td style="text-align: center;">
                                            <?php
                                            if ($hinh_anh != '') {
                                                ...
                                                ?>
                                                <img src="/files/<?php echo $hinh_anh; ?>" alt="" height="100px"
                                                     width="100px"/>
                                                <?php
                                            }
                                            ?>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td></td>
                                    <td class="text_bold"><?php echo number_format($tong);
                                        echo "đ" ?></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            ...
                            if (isset($_GET['search'])) {
                                ...
                                <div class="row">
                                    <div class="col-sm-12" style="text-align: right;">
                                        <a href="index.php" title="" class="btn btn-primary"><i class="fa fa-reply"></i>
                                            Trở về</a>
                                    </div>
                                </div>
                                <?php
                            ...
                            while ($arItem = mysqli_fetch_assoc($result)) {
                                ...
                                ?>
                                <!-- Modal -->
                                <div class="modal fade" id="<?php echo $id_sp; ?>" data-backdrop="static" tabindex="-1"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h5 class="modal-title text-bold"
                                                    id="staticBackdropLabel"><?php echo $arItem['ten_sp']; ?></h5>
                                            ...
                                            <div class="modal-body">
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    while ($arItem = mysqli_fetch_assoc($resultDB)) {
                                                        ...
                                                        <tr class="gradeX">
                                                            ...
                                                            <th><?php echo number_format($gia_sp);
                                                                echo "đ"; ?></th>
                                                            <th><?php echo number_format($gia_tong);
                                                                echo "đ"; ?></th>
                                                ...
                                                <p class="text_stong">
                                                    <b>Tổng: </b><span><?php echo number_format($tongDH);
                                                        echo "đ"; ?></span></p>
                                            </div>
